...
const About = () => {
  return (
    <div className="flex flex-col h-screen ">
      <Header />
      <div className=" w-10/12  mx-auto flex-1 items-center  mt-36 space-y-6">
        <h2 className="text-2xl font-extralight uppercase tracking-max">
          About
        </h2>

        <h2 class="whitespace-pre-line dark:text-blue text-md xs:text-2xl md:text-6xl font-extrabold">
          a frontend developer with affinity for design, intuitive user
          experience and pixel-perfect user interfaces
        </h2>

        <div class="flex flex-col space-y-4 leading-relaxed md:flex-row md:space-x-12 md:space-y-0">
          <p class="w-full whitespace-pre-line md:w-1/2">
            ...
            Science from the University of the Philippines. I have been employed
            by leading tech companies and emerging amazing startup companies
            throughout my career thus far.
          </p>
          <div class="w-full md:w-1/2">
            Currently, I am a Senior Software Engineer,{" "}
            <span class="font-bold">focusing on the frontend</span>. On a daily
            basis, I work with{" "}
            ...
            <div class="hidden md:contents">
              <div class="inline-flex items-center justify-center rounded-3xl  py-0.5 px-3 text-sm tracking-wider text-blue  space-x-2">
                <svg
                  stroke="currentColor"
                  fill="currentColor"
                  stroke-width="0"
              ...
              <div class="inline-flex items-center justify-center rounded-3xl  py-0.5 px-3 text-sm tracking-wider text-blue space-x-2">
                ...
                <div class="mt-0.5">Redux Toolkit</div>
              </div>
              ,{" "}
              <div class="inline-flex items-center justify-center rounded-3xl  py-0.5 px-3 text-sm tracking-wider text-blue space-x-2">
                <svg
                ...
                <div class="mt-0.5">TypeScript</div>
              </div>
              ,{" "}
              <div class="inline-flex items-center justify-center rounded-3xl  py-0.5 px-3 text-sm tracking-wider text-blue space-x-2">
                <svg
                ...
                <div class="mt-0.5">Tailwind CSS</div>
              </div>
              ,{" "}
              <div class="inline-flex items-center justify-center rounded-3xl  py-0.5 px-3 text-sm tracking-wider text-blue space-x-2">
                <svg
              ...
              <div class="inline-flex items-center justify-center rounded-3xl  py-0.5 px-3 text-sm tracking-wider text-blue  space-x-2">
                ...
                <div class="mt-0.5">Storybook</div>
              </div>
              ,{" "}
            </div>{" "}
            among others, in building and maintaining web applications and
            design systems —
            <span class="font-bold">all built from the ground up</span>.
          </div>
        </div>
      </div>
    </div>
